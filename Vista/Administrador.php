        ...
        <div class="row">
                ...
                <div class="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
                    ...
                    <div class="ms-3">
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0">5</h3> <span class="d-block ms-2">Usuarios</span>
                        </div>
                        <p class="fs-normal mb-0">Se muestra la cantidad de usuarios registrados</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
                    ...
                    <div class="ms-3">
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0">34</h3> <span class="d-block ms-2">Bicicletas</span>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="box d-flex rounded-2 align-items-center p-3">
                    ...
                    <div class="ms-3">
                        <div class="d-flex align-items-center">
                            <h3 class="mb-0">10</h3> <span class="d-block ms-2">Bicicletas</span>
                        </div>
