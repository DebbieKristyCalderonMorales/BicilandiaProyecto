<!DOCTYPE html>
<?php
//include_once 'Config/Restriccion.php';
?>
<html>
    <head>
        <meta charset="UTF-8">
                            ...
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                ...
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="UsuariosControl.php?accion=registro">Agregar nuevo usuario</a>
                                        <a class="dropdown-item" href="UsuariosControl.php?accion=usuarios">Listado de usuario</a>
                                    </div>
                                </li>
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
